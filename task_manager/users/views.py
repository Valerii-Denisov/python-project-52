...
class UserRegister(SuccessMessageMixin, CreateView):
    ...
    success_message = 'TThe user has been successfully registered'
...
class UserEdit(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def handle_no_permission(self):
        if self.request.user.is_authenticated:
            message = 'You dont have the rights to change another user.'
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, 'User successfully changed')
